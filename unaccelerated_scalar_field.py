...
N_trajs = 2000 # number of trajectories (equivalent to number of measurements of observables)
sweep = 0
...
outfile                 = open("m_{}_equilib_unaccelerated_1d_field.txt".format(m),"w")
av_sum_phi_sq_outfile   = open("m_{}_equilib_av_sum_phi_sq_outfile_unaccel.txt".format(m), "w")
s_outfile               = open("m_{}_equilib_unaccelerated_s_outfile.txt".format(m), "w")
delta_H_outfile         = open("m_{}_equilib_delta_H_unaccel.txt".format(m),"w")
av_x_sq_outfile         = open("m_{}_equilib_unacc_mag_av_x_sq_outfile.txt".format(m), "w")
av_x_outfile            = open("m_{}_equilib_unacc_FFT_FA_mag_av_x_outfile.txt".format(m), "w")
x_sq_file               = open("m_{}_equilib_x_sq_file.txt".format(m), "w")

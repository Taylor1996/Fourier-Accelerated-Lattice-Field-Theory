...
N_trajs = 10000000 # number of trajectories (equivalent to number of measurements of observables)
...
outfile = open("aho_lambda_0_N_t_{}_a_{}_N_trajs_{}".format(N_tau, a, N_trajs) + sys.argv[1],"w")
...
delta_H_outfile = open("anharmonic_hmc_lambda_0_delta_H_" + str(sys.argv[1]),"w")

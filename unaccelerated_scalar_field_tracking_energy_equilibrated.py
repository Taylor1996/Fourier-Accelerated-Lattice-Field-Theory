...
N_tau = 20 # size of the lattice (i.e., the length of the harmonic oscillator's path in time)
...
s_traj_outfile = open("ordered_var_t_s_traj_outfile_energy_tracking.dat", "w")

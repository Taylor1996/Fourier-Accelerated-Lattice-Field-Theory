...
outfile = open("FFT_FA_mag_fourier_accelerated_1d_scalar_field_mod_sampling.txt".format(sys.argv[1]),"w")
s_outfile = open("FFT_FA_mag_fourier_acc_s_1d_scalar_field_mod_sampling.txt", "w")
delta_H_outfile = open("FFT_FA_mag_hmc_delta_H_mod_sampling" + str(sys.argv[1]),"w")
av_x_sq_outfile = open("FFT_FA_mag_av_x_sq_outfile.txt", "w")
av_x_outfile = open("FFT_FA_mag_av_x_outfile.txt", "w")

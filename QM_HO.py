...
num_sweeps = 10000 # 100000 sweeps
...
outfile = open("output_N_tau={}_m={}_omega={}.txt".format(N_tau,m,omega),"w")
...
for sweep in range(num_sweeps):
    ...
    if(sweep % N_sep == 0):
        ...
        outfile.write(str(x))                            # also output array x at each config to file for further analysis 
        config_num +=1

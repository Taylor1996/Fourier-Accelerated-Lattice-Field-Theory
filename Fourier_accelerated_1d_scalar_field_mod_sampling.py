...
m = 0.01 # mass of particle. Do an array divided by array element-wise if you want multiple particles with different masses.
m_eff = m
...
outfile         = open("equilib_fourier_accelerated_1d_scalar_field_new_sampling.txt".format(),"w")

...
delta_H_outfile         = open("m_{}_equilib_phi4_lambda_{}_FA_hmc_delta_H_new_sampling.txt".format(m,Lambda),"w")
av_sum_phi_sq_outfile   = open("m_{}_equilib_phi4_lambda_{}_av_sum_phi_sq_outfile_FA.txt".format(m,Lambda), "w")
outfile                 = open("m_{}_equilib_phi4_lambda_{}_fourier_accelerated_1d_scalar_field_new_sampling.txt".format(m,Lambda),"w")
s_outfile               = open("m_{}_equilib_phi4_lambda_{}_fourier_acc_s_1d_scalar_field_new_sampling.txt".format(m,Lambda), "w")
av_x_sq_outfile         = open("m_{}_equilib_phi4_lambda_{}_FA_HO_mag_av_x_sq_outfile.txt".format(m,Lambda), "w")
av_x_outfile            = open("m_{}_equilib_phi4_lambda_{}_FFT_FA_mag_av_x_outfile.txt".format(m,Lambda), "w")
x_sq_file               = open("m_{}_equilib_phi4_lambda_{}_x_sq_file_FA.txt".format(m,Lambda), "w")

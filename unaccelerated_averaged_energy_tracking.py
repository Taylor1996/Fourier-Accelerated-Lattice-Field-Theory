...
s_traj_outfile =    open("ordered_unaccelerated_31site_var_t_s_traj_outfile_energy_tracking.dat", "w")
delta_H_outfile =   open("ordered_unaccelerated_31site_delta_h_energy_tracking.dat","w")
H_traj_outfile =    open("ordered_unaccelerated_31site_var_t_h_unaccel_trajenergy_tracking.dat", "w")

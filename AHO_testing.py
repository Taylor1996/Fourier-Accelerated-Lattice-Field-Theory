...
a = 0.001
N_tau = 10 #     size of the lattice (i.e., the length of the harmonic oscillator's path in time)
...
m = 0.0 # mass of particle. Do an array divided by array element-wise if you want multiple particles with different masses.
...
delta_H_outfile = open("anharmonic_testing_hmc_delta_H_" + str(sys.argv[1]),"w")

...
s_outfile       = open("small_lambda_equi_start_m_{}_dt_{}_lf_steps_{}_av_s_track_unaccelerated_AHO.txt".format(m, delta_t, lf_steps), "w")
delta_H_outfile = open("small_lambda_equi_start_m_{}_dt_{}_lf_steps_{}_delta_H_unaccelerated_AHO.txt".format(m, delta_t, lf_steps),"w")
H_traj_outfile  = open("small_lambda_equi_start_m_{}_dt_{}_lf_steps_{}_h_tracking_unaccelerated_AHO.txt".format(m, delta_t, lf_steps), "w")

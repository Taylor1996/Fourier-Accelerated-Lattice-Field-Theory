...
#q_current = np.array([1]*N_tau)
#print(grad_S(q_current))
#exit()

outfile = open("fourier_accelerated_1d_scalar_field_noFFTs.txt".format(sys.argv[1]),"w")
s_outfile = open("fourier_acc_s_1d_scalar_field_noFFTs.txt", "w")
